...
{
	printk(KERN_WARNING "IJAZ MOHAMED UMAR 1001496537\n");
	return 0;
}

SYSCALL_DEFINE2(procstat, int, pid, struct proc_stat *, ptr)
{
	...
	num_bytes = copy_to_user(ptr, &ps, sizeof(struct proc_stat)); 
